...
(function (factory) {
    ...
    var dictionary = {
        ...
        ru: {days: 'дн.', hours: 'ч.', min: 'мин.', sec: 'секунд'},
    ...
    $.fn.timeTo = function () {
        ...
        return this.each(function () {
            ...
            if (!data.vals) {
                ...
                ulhtml = '<ul style=""><li>0</li><li>0</li></ul></div>';
                style = data.fontSize
                    ? ' style=""'
                    : ' style=""';
                ...
                thtml = (data.displayCaptions
                        ? (data.displayHours
                        ? '<figure  id="hours" style="">$1<figcaption' + fsStyle + '>'
                        + language.hours + '</figcaption></figure>' + dot2
                        : '')
                        + '<figure id="min" style="">$1<figcaption' + fsStyle + '>' + language.min
                        + '</figcaption></figure>' + '<figure id="sec" style="">$1<figcaption' + fsStyle + '>' + language.min
                        + '</figcaption></figure>'
